...
def main():
    ...
    perturbation = generator.generate(
        ...
        num_iterations=16,           # Train longer without adding noise
        xi=16/255,                   # Keep noise moderate for similarity
        learning_rate=2/255,         # Step size
        alpha=0.75,                  # Slightly stronger blend
        delta=0.2,                   # 80% fooling target
        fooling_drop_ratio=0.85,     # Moderate drop threshold
        classification_weight=0.40,  # Stronger negative-prompt loss
        ...
        captions_per_image=3,        # More caption diversity
